...
const Lapuser = () => {
  return (
    <div className="flex flex-col md:h-[100vh] h-fit w-full items-center justify-center bg-slate-200 pt-[90px] pb-10">
      <div className="flex md:flex-row flex-col gap-20 text-black xl:w-[1024px] w-full px-6 py-3 md:items-start items-center">
        <h2 className="text-5xl font-bold text-dark pb-3">Buat Pengaduan</h2>
      </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <label htmlFor="fileInput" className="file-input-label">
            <input
              type="file"
              id="fileInput"
              className="file-input file-input-bordered file:bg-blue-700 w-[895px] rounded-full"
            />
          </label>
